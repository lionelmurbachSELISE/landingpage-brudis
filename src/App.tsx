...
function App() {
  return (
    <div className="min-h-screen bg-gray-100 py-4 px-1 flex flex-col justify-between w-full max-w-full overflow-x-hidden box-border">
      <div className="w-full max-w-full overflow-x-hidden">
        ...
        <main className="max-w-full mx-auto">
              ...
              <span className="text-lg md:text-xl font-bold text-gray-800 text-center mb-2">Bitte wähle das Herkunftsland des Weins:</span>
      ...
      <footer className="w-full flex flex-row items-center justify-center gap-2 mt-8 mb-2 max-w-full overflow-x-hidden">
        <span className="text-gray-700 text-[10px] sm:text-xs md:text-sm whitespace-nowrap">Self-Ordering by</span>
